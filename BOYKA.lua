...
send(msg.chat_id_, msg.id_, " يوزر قمد يستا ["..BOYKAChengName..']')
...
{{text = 'صــاحــب الــســورس', url="t.me/BringoX}},
...
if text == 'مارتن' or text == 'marten' or text == 'مطور السورس' then
local Text = [[
مطور السورس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩𝙼𝙰𝚁𝚃𝙴𝙽𓆪',url="t.me/I_C_X"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[ 
[CH ↝ 𝐏𝐑𝐎𝐎](t.me/PROO_UU_4)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙲𝙷 ↝ 𝐏𝐑𝐎𝐎', url="t.me/PROO_UU_4"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ خدوني معاكم بف ..😉❤️](t.me/PROO_UU_4)')
return false
end
end
end
...
local list = database:smembers(bot_id.."botss:DevBOYKAW:List:Rd:Sudo")
text = "\nقائمة ردود المتعدده \nٴ≪⚛━━━━━━𝐏𝐑𝐎𝐎━━━━━━⚛≫ٴ\n"
for k,v in pairs(list) do
db = "رساله "
text = text..""..k.." => {"..v.."} => {"..db.."}\n"
...
database:set(bot_id.."botss:DevBOYKAW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:DevBOYKAW:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"⚛ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:DevBOYKAW:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DevBOYKAW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:DevBOYKAW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DevBOYKAW:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DevBOYKAW:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DevBOYKAW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:DevBOYKAW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DevBOYKAW:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DevBOYKAW:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DevBOYKAW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:DevBOYKAW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DevBOYKAW:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"⚛تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:DevBOYKAW:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:DevBOYKAW:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:DevBOYKAW:Add:Rd:Sudo:Text2"..text)   
...
if text == 'تغير امر ⓵' and DevBOYKAW(msg) then
